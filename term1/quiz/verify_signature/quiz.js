...
console.log(bitcoinmsg.verify(message, address, signature_1))
console.log(bitcoinmsg.verify(message, address, signature_2))
console.log(bitcoinmsg.verify(message, address, signature_3))
